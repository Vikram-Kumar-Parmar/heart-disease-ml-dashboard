...
if st.button("Predict"):
    ...
    if pred == 1:
        st.error(f"⚠️ Disease Present (Confidence: {prob:.2f})")
    else:
    ...
    st.write(
        "The prediction is influenced by the most important features shown above. "
        "These represent the strongest signals the model uses to assess cardiac risk."
    )
